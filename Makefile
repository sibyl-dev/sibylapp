...
# -------------- End of session: installation ---------------- #


# -------------- Begin of session: coding style and test ---------------- #
...
# -------------- End of session: coding style check ---------------- #



# -------------- Begin of session: API documentation ---------------- #
...
view-apidocs:	## view server API docs
	$(BROWSER) apidocs/index.html

# -------------- End of session: API documentation ---------------- #
...
load-db: init-db
	...
	curl -o sibylapp.zip "https://d3-ai-sibyl.s3.amazonaws.com/sibylapp.zip"
	unzip sibylapp.zip -d ./db/ && rm sibylapp.zip
